...
class Products {
    ...
    async create(values: any, res: Response): Promise<void>{

        const createdUnitary = values.unitary? await Product.createUnitary(values.unitary, res) : false;
        if(!createdUnitary){
            res.status(201).json({
                code: 201,
            ...
            const createdKit2 = values.kit2? Product.createKit(values.kit2, values.unitary.pricing.mundial, createdUnitary.tray_product_id, res) : 0
            const createdKit4 = values.kit4? Product.createKit(values.kit4, values.unitary.pricing.mundial, createdUnitary.tray_product_id, res) : 0
